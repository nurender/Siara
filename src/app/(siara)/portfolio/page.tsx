...
import { getSettings, getPortfolio, getPage } from '@/lib/cms';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: page?.meta_title || `Portfolio | ${siteName} - Best Wedding Planner in Rajasthan`,
    description: page?.meta_description || 'Explore our stunning portfolio of luxury destination weddings in Rajasthan. Discover royal celebrations at Jaipur, Udaipur, and Jodhpur palaces.',
    keywords: 'wedding portfolio, Rajasthan weddings, palace weddings, destination wedding photos, luxury wedding gallery',
    openGraph: {
      title: page?.meta_title || `Portfolio | ${siteName}`,
      description: page?.meta_description || 'Explore our stunning portfolio of luxury destination weddings in Rajasthan.',
      type: 'website',
...
async function getPageData() {
  try {
    const [pageData, portfolio, settings] = await Promise.all([
      getPage('portfolio'),
      getPortfolio(),
      getSettings(),
    ]);
        ...
        <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-6 lg:px-8 text-center py-32">
            ...
            <p className="font-dm-sans text-lg md:text-xl text-siara-purple-200/80 max-w-2xl mx-auto mb-10">
              Our portfolio page content is being prepared. Please visit the admin panel to add sections.
            </p>
